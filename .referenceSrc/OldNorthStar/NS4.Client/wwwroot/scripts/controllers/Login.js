(function () {
    ...
    LoginController.$inject = ['$scope', '$global', '$http', 'authService', 'ngAuthSettings','$location','progressLoader'];


    function LoginController($scope, $global, $http, authService, ngAuthSettings, $location, progressLoader) {
