(function () {
    ...
    .factory('authInterceptorService', ['$rootScope', '$cookies', '$q', '$injector', '$location', 'localStorageService', function ($rootScope, $cookies, $q, $injector, $location, localStorageService) {
    ...
    .factory('authService', ['$http', '$q', 'localStorageService', 'ngAuthSettings', '$location', function ($http, $q, localStorageService, ngAuthSettings, $location) {
        ...
        var _login = function (loginData) {
            ...
            var data = "scope=idmgr&grant_type=password&username=" + loginData.userName + "&password=" + loginData.password + "&client_id=" + ngAuthSettings.clientId + "&client_secret=secret";
