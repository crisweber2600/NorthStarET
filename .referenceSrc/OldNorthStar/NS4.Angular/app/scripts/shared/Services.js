...
angular
    ...
    .service('nsSelect2RemoteOptions', [
        'authService', 'nsFilterOptionsService', 'webApiBaseUrl', '$routeParams', function (authService, nsFilterOptionsService, webApiBaseUrl, $routeParams) {
            ...
            this.quickSearchSectionsCurrentYearRemoteOptions = {
                placeholder: "Search for a section",
                minimumInputLength: 3,
                width: 'resolve',
                multiple: false,
                id: function (section) { return section.id; },
                ajax: {
                    url: webApiBaseUrl + "/api/section/QuickSearchSectionsCurrentYear",
                    dataType: 'json',
                    quietMillis: 250,
                    transport: function (params) {
                        params.beforeSend = function (request) {
            ...
            this.quickSearchPageToolsRemoteOptions = {
                ...
                ajax: {
                    url: webApiBaseUrl + "/api/interventiontoolkit/quicksearchpagetools",
                    dataType: 'json',
                    quietMillis: 250,
                    transport: function (params) {
                        params.beforeSend = function (request) {
            ...
            this.quickSearchPresentationsRemoteOptions = {
                ...
                ajax: {
                    url: webApiBaseUrl + "/api/interventiontoolkit/quicksearchpresentations",
                    dataType: 'json',
                    quietMillis: 250,
                    transport: function (params) {
                        params.beforeSend = function (request) {
            ...
            this.StudentServicesMultipleRemoteOptions = {
                placeholder: "Search for Student Services",
                minimumInputLength: 0,
                width: 'resolve',
                multiple: true,
                id: function (label) { return label.id; },
                ajax: {
                    url: webApiBaseUrl + "/api/student/GetStudentServices",
                    dataType: 'json',
                    quietMillis: 250,
                    transport: function (params) {
                        params.beforeSend = function (request) {
            ...
            this.StudentServicesSingleRemoteOptions = {
                placeholder: "Search for a Student Service",
                minimumInputLength: 0,
                width: 'resolve',
                multiple: false,
                id: function (label) { return label.id; },
            ...
            this.StudentDetailedQuickSearchRemoteOptions = {
                ...
                formatSelection: function (student) { return "<b>" + student.LastName + ", " + student.FirstName + " " + (student.MiddleName || '') + "</b> | Key: <b>" + student.StudentIdentifier + "</b> " + (student.GradeName ? " | Grade: <b> " + student.GradeName + "</b>" : ""); },
                dropdownCssClass: "bigdrop", // apply css that makes the dropdown taller
                escapeMarkup: function (m) { return m; } // we do not want to escape markup since we are displaying html in results
            };
            this.StudentDetailedQuickSearchCurrentYearRemoteOptions = {
                placeholder: "Search for a student",
                minimumInputLength: 2,
                width: 'resolve',
                initSelection: function (element, callback) {
                ...
                //id: function (staff) { return staff.id; },
                ajax: {
                    url: webApiBaseUrl + "/api/student/quicksearchstudentdetailedcurrentyear",
                    transport: function (params) {
                        params.beforeSend = function (request) {
                            request.setRequestHeader("Authorization", 'Bearer ' + authService.token());
                        };
            ...
            this.StaffDetailedQuickSearchRemoteOptions = {
                placeholder: "Search for staff",
                minimumInputLength: 2,
                width: 'resolve',
                initSelection: function (element, callback) {
                ...
                formatResult: function (staff) {
                    ...
                    var markup = "<div>";
                    markup += "<b>" + staff.LastName + ", " + staff.FirstName + "</b> | Key: <b>" + staff.TeacherKey + "</b>  " + inactiveLabel;
                    markup += "<br>" + staff.Email + " | Internal ID: <b>" + staff.id + "</b>";
                    markup += "</div>";
                    return markup;
                },
                formatSelection: function (staff) { return "<b>" + staff.LastName + ", " + staff.FirstName + "</b> | Key: <b>" + staff.TeacherKey + "</b>  | Internal ID: <b> " + staff.id + "</b>"; },
                dropdownCssClass: "bigdrop", // apply css that makes the dropdown taller
                escapeMarkup: function (m) { return m; } // we do not want to escape markup since we are displaying html in results
            };
            ...
            this.HfwMultiStudentReportRemoteOptions = {
                placeholder: "-Choose Hfw Student Report Types-",
                minimumInputLength: 0,
                width: 'resolve',
                multiple: true,
                initSelection: function (element, callback) {
                ...
                //id: function (staff) { return staff.id; },
                ajax: {
                    url: webApiBaseUrl + "/api/ImportStateTestData/QuickSearchHfwStudentReports",
                    transport: function (params) {
                        params.beforeSend = function (request) {
                            request.setRequestHeader("Authorization", 'Bearer ' + authService.token());
                        };
            ...
            this.QuickSearchPageTypesToPrint = {
                placeholder: "-Choose Page Types-",
                minimumInputLength: 0,
                width: 'resolve',
                multiple: true,
                initSelection: function (element, callback) {
                ...
                //id: function (staff) { return staff.id; },
                ajax: {
                    url: webApiBaseUrl + "/api/ImportStateTestData/QuickSearchPageTypesToPrint",
                    transport: function (params) {
                        params.beforeSend = function (request) {
                            request.setRequestHeader("Authorization", 'Bearer ' + authService.token());
                        };
            ...
            this.QuickSearchTextLevelZones = {
                ...
                //id: function (staff) { return staff.id; },
                ajax: {
                    url: webApiBaseUrl + "/api/ImportStateTestData/QuickSearchTextLevelZones",
                    transport: function (params) {
                        params.beforeSend = function (request) {
                            request.setRequestHeader("Authorization", 'Bearer ' + authService.token());
                        };
...
.service('nsPinesService', ['pinesNotifications', '$rootScope', function (pinesNotifications, $rootScope) {
