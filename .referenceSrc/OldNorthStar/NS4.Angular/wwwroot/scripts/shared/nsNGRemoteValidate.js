...
(function (angular) {
    ...
    var directiveId = 'ngRemoteValidate2',
        remoteValidate2 = function ($http, $timeout, $q) {
            return {
                restrict: 'A',
    ...
    angular.module('remoteValidation2', [])
           .constant('MODULE_VERSION', '##_version_##')
           .directive(directiveId, ['$http', '$timeout', '$q', remoteValidate2]);
