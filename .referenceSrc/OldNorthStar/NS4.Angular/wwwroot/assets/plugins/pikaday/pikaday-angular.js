        ...
        return {
            ...
            link: function ($scope, $elem) {
                ...
                $scope.$watchGroup(["format", "minDate", "maxDate", "numberOfMonths", "disableWeekends", "yearRange", "defaultDate"], function () {
                    ...
                    var date = new Date();
                    format = $scope.format || "DD-MMM-YYYY",
                    defaultDate = ("undefined" != typeof $scope.defaultDate && $scope.defaultDate != null && $scope.defaultDate != '') ? moment($scope.defaultDate, 'DD-MMM-YYYY').toDate() : !1,
