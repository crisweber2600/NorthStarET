			...
			dist: {
				files: {
					src: [
                      ...
                      '<%= yeoman.dist %>/scripts/customns.js',
                      '<%= yeoman.dist %>/scripts/vendor.js',
					  '<%= yeoman.dist %>/styles/nsscreenstyles.css',
                      '<%= yeoman.dist %>/styles/nsprintstyles.css',
                      '<%= yeoman.dist %>/styles/nsstyles.css',
                      '<%= yeoman.dist %>/assets/css/vendor.css',
                      '<%= yeoman.dist %>/assets/css/northstar.css'
