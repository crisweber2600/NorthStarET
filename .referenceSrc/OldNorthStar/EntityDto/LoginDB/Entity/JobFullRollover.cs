...
{
    public class JobFullRollover : BaseEntity, INorthStarJob
    {
    ...
    public class JobFullRolloverDto : BaseEntity, INorthStarJob
    {
        public JobFullRolloverDto()
        {
    ...
    public class RolloverLogMessage
    {
