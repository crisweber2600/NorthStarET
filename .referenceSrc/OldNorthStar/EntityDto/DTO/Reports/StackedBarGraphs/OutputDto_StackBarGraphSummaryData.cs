...
{
    public class OutputDto_StackBarGraphSummaryData : OutputDto_Base
    {
        public OutputDto_StackBarGraphSummaryData()
        {
            
        }

        public List<TestDueDateDto> TestDueDates { get; set; }
        public List<StackedBarGraphSummaryRecord> SummaryRecords { get; set; }
