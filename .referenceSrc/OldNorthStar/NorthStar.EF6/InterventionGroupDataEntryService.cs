...
{
    public class InterventionGroupDataEntryService :NSBaseDataService
    {
        public InterventionGroupDataEntryService(ClaimsIdentity user, string loginConnectionString) : base(user, loginConnectionString)
        {

        }

        public OutputDto_StudentAssessmentResults GetIGAssessmentResults(InputDto_AssessmentInterventionGroupStudent input)
        {
            ...
            var studentResults = _dbContext.GetIGAssessmentStudentResults(assessment, input.InterventionGroupId, input.StudentId);
        ...
        public void DeleteAssessmentResult(InputDto_SaveAssessmentResult input)
        {
        ...
        public InputDto_SaveAssessmentResult SaveAssessmentResult(InputDto_SaveAssessmentResult input)
        {
            ...
            using (System.Data.IDbCommand command = _dbContext.Database.Connection.CreateCommand())
            {
                try
                {
                    ...
                    else
                    {
                        ...
                        insertUpdateSql.AppendFormat(" WHERE StudentId = {0} AND InterventionGroupId = {1} and ID = {2}", input.StudentResult.StudentId, input.StudentResult.ClassId, input.StudentResult.ResultId);
                    }
