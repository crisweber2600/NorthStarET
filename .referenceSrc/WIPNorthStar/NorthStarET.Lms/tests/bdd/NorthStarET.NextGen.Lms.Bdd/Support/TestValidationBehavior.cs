...
/// <summary>
/// MediatR pipeline behavior that executes FluentValidation validators within BDD scenarios.
/// </summary>
public sealed class TestValidationBehavior<TRequest, TResponse> : IPipelineBehavior<TRequest, TResponse>
