...
**Feature**: Migrate authentication and authorization to Microsoft Entra ID (never any other identity provider)
**Epic**: Phase 1 - Foundation Services
**Service**: Microsoft Entra ID Authentication & Authorization
...
7. Migrate user accounts with email matching strategy (see legacy-identityserver-migration.md)
